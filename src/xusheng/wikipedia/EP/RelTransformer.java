...
public class RelTransformer {

	private HashSet<String> modalSet = null;
	
	private static RelTransformer inst = null;
	
	public static RelTransformer getInstance() throws Exception {
		if (inst == null) inst = new RelTransformer();
		return inst;
	}
	
	RelTransformer() throws Exception {
...
//		System.out.println("sb: " + sb.toString());
	...
	public static void main(String[] args) throws Exception {
		RelTransformer dt = new RelTransformer();
        ...
        while ((line = br.readLine()) != null) {
            ...
            String rel = dt.processCaseNew("X", spt[1], "Y");
            bw.write(rel + "\n");
        }
        br.close();
        bw.close();
